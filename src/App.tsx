    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0a0e27] to-[#16213e] p-4 sm:p-6 lg:p-8" onClick={!isAudioReady ? initAudioContext : undefined}>
            <div className="max-w-screen-2xl mx-auto">
                ...
                />
                <main className="flex flex-col md:flex-row gap-4 sm:gap-6">
                    ...
                    <div className="flex-grow flex flex-col lg:flex-row gap-4 sm:gap-6 min-w-0">
                         <div className="flex-grow min-w-0 animate-slide-in-right" style={{ animationDelay: '100ms' }}>
                            <TrackList
             ...
             {!isAudioReady && (
                <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-[100] animate-fade-in">
